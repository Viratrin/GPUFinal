/*
 * One CUDA block per contract
 *
 * Compile:
 *      nvcc -O2 --use_fast_math -o main_v2 main_v2.cu csv_parser.c -lm -lcurand
 *
 * Usage:
...
int main(int argc, char *argv[]) {
    ...
    // parse CSV
    printf("\n=== Kaggle SPY Dataset Pricing (v2: block-per-contract) ===\n");
...
// Throughput             : 305753.51 contracts/sec
